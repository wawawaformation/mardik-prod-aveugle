% =========================================================
% Style Pandoc PDF - Note de diagnostic Mardik
% Style local au projet, derive de ~/.config/pandoc/styles/conception.tex
% David LEGRAND et Sofiane
% =========================================================
...
\fancyhf{}
\fancyhead[L]{Note de diagnostic -- Application Mardik}
\fancyhead[R]{\thepage}
\fancyfoot[L]{David et Sofiane}
\fancyfoot[R]{\today}
